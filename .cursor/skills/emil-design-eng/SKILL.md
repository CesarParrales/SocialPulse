...
description: >-
  Design engineering (Emil Kowalski): pulido de UI, componentes, decisiones de
  animación y detalles “invisibles”. Usar al implementar, refinar o revisar
  interfaces, motion, transiciones, estados e interacción; tablas Before/After/Why
  en revisiones. Inglés en el cuerpo; criterios de animations.dev / Kowalski.
---
