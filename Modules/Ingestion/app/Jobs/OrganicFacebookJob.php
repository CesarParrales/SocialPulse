...
class OrganicFacebookJob implements ShouldQueue
{
    ...
    public function handle(OrganicFacebookIngestionService $service): void
    {
        ...
        if ($log->status->value === 'error') {
            throw new \RuntimeException($log->error_message ?? 'Organic Facebook ingestion failed.');
        }
    }
}
