...
class OrganicYouTubeJob implements ShouldQueue
{
    ...
    public function handle(OrganicYouTubeIngestionService $service): void
    {
        ...
        if ($log->status->value === 'error') {
            throw new \RuntimeException($log->error_message ?? 'Organic YouTube ingestion failed.');
        }
    }
}
