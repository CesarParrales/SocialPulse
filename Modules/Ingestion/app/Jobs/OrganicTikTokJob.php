...
class OrganicTikTokJob implements ShouldQueue
{
    ...
    public function handle(OrganicTikTokIngestionService $service): void
    {
        ...
        if ($log->status->value === 'error') {
            throw new \RuntimeException($log->error_message ?? 'Organic TikTok ingestion failed.');
        }
    }
}
